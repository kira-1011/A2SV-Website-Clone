  ...
  return (
    ...
    <div className="flex flex-col gap-8 items-center lg-1:items-start">
      ...
      <div className="flex justify-center text-sm w-full gap-4 lg-1:justify-start md:text-xl md:gap-8 ">
        <button onClick={() => router.push("/signup")} className="text-primary-color font-medium  bg-smoke rounded-lg border-[3px] border-primary-color px-4 py-3 md:px-10 md:py-4">
          Get Started
        </button>
